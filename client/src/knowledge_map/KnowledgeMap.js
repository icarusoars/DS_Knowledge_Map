...
import KnowledgeMapLabel from "./KnowledgeMapLabel";
    ...
    return (
      <div id="KnowledgeMap">
        <Row style={{ height: "100%" }}>
          ...
          >
            <KnowledgeMapLabel
              currentCircleLabel={this.state.currentCircleLabel}
            />
            <KnowledgeMapInfo
              currentCircleInfoPath={this.state.currentCircleInfoPath}
            />
          </Col>
        </Row>
      </div>
